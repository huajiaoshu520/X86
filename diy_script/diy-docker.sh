...
# dockerd
# wget https://codeload.github.com/moby/moby/tar.gz/docker-v29.3.0
# sha256sum docker-v29.1.3
sed -i -e 's/29.1.1/29.3.0/g' \
       -e 's/65221f1c70feb1bd1562bb1017b586e4528be877656dc16f5be5659fc9b7e522/ac591291294da599e824f91d6a21a43bf93503b8ab608faa198899b3f973d7c5/g' \
       -e 's/9a84135/83bca51/g' ./feeds/packages/utils/dockerd/Makefile

# docker
# wget https://codeload.github.com/docker/cli/tar.gz/v29.3.0
sed -i -e 's/29.1.1/29.3.0/g' \
       -e 's/a02081b7d6fb10bfbc8afb621e7edc5124048b31eea7a1ab73c7ccd924b03a66/47d6dae52c7fff35cf9e41d465c57626564c8ba58447b4ef345901977f63ac8a/g' \
       -e 's/0aedba5/5927d80/g' ./feeds/packages/utils/docker/Makefile
