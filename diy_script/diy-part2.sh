...
sed -i 's/PKG_RELEASE:=8/PKG_RELEASE:=0/g' ./feeds/luci/applications/luci-app-lucky/Makefile
sed -i 's/PKG_VERSION:=1.2.0/PKG_VERSION:=2.14.0/g' ./feeds/luci/applications/luci-app-lucky/Makefile
