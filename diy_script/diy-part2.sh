...
#git clone https://github.com/Jason6111/dockerd ./feeds/packages/utils/dockerd
...
sed -i 's/PKG_VERSION:=2.10.8/PKG_VERSION:=2.15.7/g' ./feeds/packages/net/lucky/Makefile
