...
#echo 'src-git helloworld https://github.com/zxlhhyccc/helloworld2' >>feeds.conf.default
...
echo "src-git luci_onlineupdate https://github.com/Jason6111/luci-app-onlineupdate" >> feeds.conf.default
